...
<template>
  <div class="page">
    ...
    <section class="intro-section">
      <LightSvg
        class="intro-deco intro-light"
        width="51"
        height="70"
        aria-hidden="true"
      />
      <TriangleSvg
        class="intro-deco intro-triangle"
        width="52"
        height="49"
        aria-hidden="true"
      />
      <CircleSvg
        class="intro-deco intro-circle"
        width="38"
        height="45"
        aria-hidden="true"
      />
    ...
    <section class="step-frame-section">
      <Plan
        class="intro-deco"
        style="left: 29px; top: -11px"
        aria-hidden="true"
      />
      <Cloud
        class="intro-deco"
        style="right: 63px; top: 16px"
        aria-hidden="true"
      />
      <Cloud
        class="intro-deco"
        style="right: 63px; bottom: 13px"
        aria-hidden="true"
      />
      <div class="step-section-inner">
        ...
        <LandingStep
          :title="'診断をスタート'"
          content="全6問の簡単な質問に答えていきます。<br />自分の本当の好みを知るために、あまり考えすぎず、ありのままの自分に当てはまるものを選んでください。"
          :step="1"
        />
        <ArrowDownSvg />
        <LandingStep
          :title="'あなたの旅タイプを知る'"
          content="計画型、自由型、弾丸冒険型など、全6タイプの中からあなたの個性にマッチした旅のスタイルを解説します。"
          :step="2"
        />
        <ArrowDownSvg />
        ...
        <LandingStep
          :title="'最高の旅へ出かけよう'"
          content="診断結果をヒントに、あなたにあったeSIMプランをご提案します。新しい自分に出会う旅へ出かけましょう。"
          :step="3"
        />
      </div>
    </section>
    ...
    <section class="types-section">
      ...
      <div class="types-grid">
        <AccentFrame
          v-for="card in mbtiTypeCards"
          :key="card.code"
          class="types-card"
        >
          <article class="types-card-content">
            <img
              class="types-card-image"
              :src="card.image"
      ...
      <div class="simless-connect-wrap">
        <span
          class="simless-deco simless-deco-stripe"
          aria-hidden="true"
        >
...
<path d="M28.0098 18.8203L39.6798 47.1103L44.7898 49.2403L31.6198 17.3203L28.0098 18.8203Z" fill="#FFEC9E"/>
<path d="M35.0098 15.9304L49.5598 51.2304L54.6798 53.3504L38.6298 14.4404L35.0098 15.9304Z" fill="#FFEC9E"/>
...
<path d="M56.0098 7.26953L79.2298 63.5695L84.3398 65.6895L59.6298 5.76953L56.0098 7.26953Z" fill="#FFEC9E"/>
<path d="M63.0098 4.37965L89.1198 67.6796L94.2298 69.8096L66.6298 2.88965L63.0098 4.37965Z" fill="#FFEC9E"/>
<path d="M73.6295 0L70.0195 1.49L99.0095 71.8L104.12 73.92L73.6295 0Z" fill="#FFEC9E"/>
        ...
        <span
          class="simless-deco simless-deco-pink-ring"
          aria-hidden="true"
        ></span>
...
<path d="M4.0658 1.03296C4.5358 2.88296 5.35582 4.61296 6.46582 6.12296C7.57582 7.63296 8.97583 8.94296 10.5958 9.94296C12.2158 10.943 14.0658 11.643 16.0658 11.953C18.0658 12.263 20.0358 12.153 21.8858 11.683C23.7358 11.213 25.4658 10.393 26.9758 9.28296C28.4958 8.17296 29.7958 6.77296 30.7958 5.15296" stroke="#FFDE59" stroke-width="8.39" stroke-linejoin="round"/>
</svg>
